...
def test_busco_synteny_default_memory(mock_bsub, mock_ctx):
    mock_ctx.print_only = True
    mock_bsub.return_value = "12345"
...
@patch("grit.steps.optional.busco_synteny._submit_bsub")
def test_busco_synteny_bsub_ram_override(mock_bsub, mock_ctx):
    mock_ctx.print_only = True
...
def test_rename_and_orient_default_memory(
